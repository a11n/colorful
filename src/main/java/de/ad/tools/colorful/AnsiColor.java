...
/**
 * <p>An enumeration providing some ANSI color constants.</p>
 * 
 * <p><b>Note:</b> ANSI codes are not supported by every terminal/console.</p>
 * 
 * <p>Example usage:</p>
 * <code>System.out.println(AnsiColor.RED.applyTo("red"));</code>
 * 
